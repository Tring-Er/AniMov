...
class TheFlix(Provider):
    ...
    def download_or_play_tv_show(self, show: Media, selected_season: str, selected_episode: str, mode: str) -> None | str | Exception:
        ...
        episode_cdn_id_data = self.web_scraper.get_episode_cdn_id(url)
        ...
        episode_cdn_url_data = self.web_scraper.get_episode_cdn_url(self.BASE_TV_SHOW_EPISODE_CDN_URL, episode_cdn_id_or_exception)
    ...
    def download_or_play_movie(self, show: Media, mode: str) -> None | str | Exception:
        ...
        show_cdn_data = self.web_scraper.get_movie_cdn_data(show_url)
        show_cdn_id = self.filter_show_cdn_id(show_cdn_data)
        cdn_data = self.web_scraper.get_movie_cnd_url(self.BASE_MOVIE_CDN_URL, show_cdn_id)
